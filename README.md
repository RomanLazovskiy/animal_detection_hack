...
Для классификации использована модель Visual Transformer (ViT). Модель ViT представляет собой одно из самых современных решений для задач классификации изображений. Благодаря своей архитектуре, основанной на трансформерах, ViT обеспечивает высокую точность и производительность, что делает ее идеальной для классификации различных объектов.

#### Преимущества Visual Transformer

- **Высокая точность**: ViT демонстрирует превосходные результаты в задачах классификации благодаря использованию механизмов внимания, которые позволяют модели эффективно фокусироваться на важных частях изображения.
- **Масштабируемость**: Модель легко масштабируется и адаптируется для работы с различными размерами изображений и объемами данных, что делает ее универсальной для различных приложений.
...
### Ссылка на модель классификации
https://drive.google.com/file/d/1Ey_C_TGIyVOH1H4i6iSAHC_o3oG-P1OO/view?usp=sharing

### Ссылка на модель детекции
